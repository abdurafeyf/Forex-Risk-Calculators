...
$module     = 'forex';
$page       = 'position-size';
$pageTitle  = 'Forex Position Size Calculator';
    ...
    <div class="row">
        ...
        <div class="col-lg-3 pl-lg-4 pr-lg-0 mt-sm-minus-20 mb-3">
            <div class="cagr-calulator">
                <h1 style="font-size:24px; text-transform:uppercase">Position Size Calculator <sup><span class="badge badge-danger font-11 font-weight-normal">Beta</span></sup></h1>
                ...
                <div class="calculator-form border p-3 bg-white mt-2 mb-1 shadow-sm rounded">
                    <form action="#" method="POST" id="forexRiskCalculatorForm">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Stoploss (Pips)</label>
                                    <input class="form-ctrl" type="number" value="100" id="stop-loss" placeholder="Enter stoploss (pips)" required>
                                </div>
                            </div>
                            <div class="col-md-12">
